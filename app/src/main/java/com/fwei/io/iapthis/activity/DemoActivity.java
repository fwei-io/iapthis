package com.fwei.io.iapthis.activity;
...
import com.fwei.io.iapthis.common.CipherUtil;
import com.fwei.io.iapthis.common.Key;
import com.fwei.io.iapthis.R;
...
public class DemoActivity extends Activity {
    ...
    private void loadProduct() {
        Toast.makeText(DemoActivity.this, "Loading", Toast.LENGTH_SHORT).show();
        ...
        task.addOnSuccessListener(new OnSuccessListener<ProductInfoResult>() {
            ...
            public void onSuccess(ProductInfoResult result) {
                if (result != null && !result.getProductInfoList().isEmpty()) {
                    Toast.makeText(DemoActivity.this, "Got some results", Toast.LENGTH_SHORT).show();
    ...
    private ProductInfoReq createProductInfoReq() {
        ...
        ProductInfoReq req2 = new ProductInfoReq();
        ProductInfoReq req3 = new ProductInfoReq();
        ...
        productIds.add("com.fwei.io.iapthis.gem.001");
        productIds.add("com.fwei.io.iapthis.gem.002");
        productIds.add("com.fwei.io.iapthis.gem.003");
        productIds.add("com.fwei.io.iapthis.gem.004");
        productIds.add("com.fwei.io.iapthis.gem.005");
        productIds.add("com.fwei.io.iapthis.gem.006");
